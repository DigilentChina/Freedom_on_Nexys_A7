...
//-------------------------------------------------------------------------
// E300Nexys4DDRDevKitPlatform
//-------------------------------------------------------------------------

class E300Nexys4DDRDevKitPlatform(implicit val p: Parameters) extends Module {
  val sys = Module(LazyModule(new E300Nexys4DDRDevKitSystem).module)
  val io = new E300Nexys4DDRDevKitPlatformIO
